export class CustomValidator {
  ...
  static dateValidator(number): any {
    ...
    const DATE_REGEXP_1 = /^((0[1-9]|1[0-2]|[1-9])-(0[1-9]|[12]\d|3[01]|[1-9])-[12]\d{3})$/;
    const DATE_REGEXP_2 = /^((0[1-9]|1[0-2]|[1-9])\/(0[1-9]|[12]\d|3[01]|[1-9])\/[12]\d{3})$/;
    number.markAsTouched();
    if (DATE_REGEXP_1.test(number.value) || DATE_REGEXP_2.test(number.value)) {
      return null;
    }
    return {
       invalidDate: true
